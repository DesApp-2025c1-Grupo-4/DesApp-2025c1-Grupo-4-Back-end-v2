...
const { validarId, validarPatenteVehiculo, validarCampoDuplicado } = require('../middleware/idValidador')
...
routes.post('/', schemasValidador(vehiculoSchema), validarCampoDuplicado(Vehiculo, 'patente', 'vehículo', 'un'), VehiculoController.addVehiculo)
